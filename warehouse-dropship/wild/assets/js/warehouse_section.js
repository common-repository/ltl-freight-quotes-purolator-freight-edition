    jQuery(document).ready(function() {
        ...
        // Origin and product level markup validations
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (data.insert_qry == 1) {
                        ...
                        jQuery('.dropship_created').css('display', 'none');
                        window.location.href = jQuery('.close').attr('href');
                        jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-purolator-freight-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-purolator-freight-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                    }
                    else {
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (data.insert_qry == 1) {
                        ...
                        jQuery('.warehouse_created').css('display', 'none');
                        window.location.href = jQuery('.close').attr('href');
                        jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-purolator-freight-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-purolator-freight-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                    }
                    else {
                        jQuery('.already_exist').show('slow');
                        jQuery( '.content' ).delay( 200 ).animate({scrollTop: 0 }, 300);
