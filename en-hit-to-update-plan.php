...
$get_option = get_option('purolator_ltl_quotes_web_hook_plan_requests');
...
update_option('purolator_ltl_quotes_web_hook_plan_requests' , json_encode($en_web_hook_requests));
...
if($plan == '0' || $plan == '1' || $plan == '2' || $plan == '3')
{
    ...
    update_option('purolater_ltl_package_expire_days' , "$expire_days");
